...
* [ ] Math kitaplığındaki iki yöntemi kullanan bu ifadeye eşit olarak ayarlayın. `Math.floor(Math.random() * 8);`
...
* [ ] Set it equal to this expression, which uses two methods from the Math library. `Math.floor(Math.random() * 8);`
